...
frappe.ui.form.on("Proforma Invoice", {
	...
	// 	setTimeout(() => {
    //     frm.call({
    //         method: "get_proforma_data",
    //         doc: frm.doc,
    //         callback: async function(r) {
    //             if (r.message) {
	// 				console.log(r.message)
	// 				frm.doc.taxes_and_charges = r.message
    ...
    //             doc: frm.doc,
    //             callback: function(r) {
    //                 if (r.message && r.message.tax_template) {
	// 					console.log(r.message.tax_template)
    //                     frm.set_value("taxes_and_charges", r.message.tax_template);
    //                     frappe.msgprint("Applied Tax Template: " + r.message.tax_template);
	// 					frm.refresh_fields();
    //                 } else {
    //                     frappe.msgprint("No tax template applied.");
    //                 }
    //             }
    //         });
    //     }
